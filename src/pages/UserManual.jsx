            ...
            <div className="max-w-5xl mx-auto px-4 py-8">
                <div className="space-y-8">
                    ...
                    <div className="text-center mb-12">
                        <h1 className="text-3xl font-bold mb-4">Field Day Wildlife Data Collection App</h1>
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="text-gray-800 leading-relaxed">
                            ...
                            designed to address field researchers' challenges, particularly those
                            in biology and ecology. The project consists of:
                        </p>
                        ...
                        <div className="bg-blue-50 rounded-lg p-6 mt-6">
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                ...
                                <li>Population data collection using capture mark-recapture techniques</li>
                    ...
                    <section className="space-y-4">
                        ...
                        <div className="bg-white rounded-lg border p-6">
                            ...
                            <ol className="list-decimal pl-6 space-y-4">
                                <li>Access the PWA at <a href="https://asu-field-day-pwa.web.app/" className="text-blue-600 hover:underline">https://asu-field-day-pwa.web.app/</a> on your mobile device</li>
                                <li>Enter your handler initials (2-3 characters required)</li>
                                <li>Select your project, site, and array from the dropdown menus</li>
                            </ol>
    ...
    <div className="bg-white rounded-lg border p-6">
        ...
        <ol className="list-decimal pl-6 space-y-4">
            ...
            <li className="space-y-2">
                ...
                <ul className="list-disc pl-6">
                    <li>Simply use a + between terms to search for multiple items</li>
                    <li>Example: <code className="bg-gray-100 px-2 py-1 rounded">ASTI+A1B2</code> will find entries containing both "ASTI" and "A1B2"</li>
                </ul>
            </li>
        ...
        <div className="bg-blue-50 rounded-lg p-4 mt-6">
            ...
            <p>The search will return any records that contain all the terms
            you entered, regardless of their order or location in the record.</p>
        </div>
        ...
        <div className="mt-6">
            ...
            once complete choose end session. .</p><br></br>
                            ...
                            src="/manualImages/verify.png" 
                                ...
                                />
                                <p className="text-center text-gray-600 mt-2">
                                    Verification screen showing entered  data before final submission<br></br>
                    ...
                    <section className="space-y-4">
                        ...
                        <div className="bg-white rounded-lg border p-6">
                            ...
                            <div className="bg-blue-50 rounded-lg p-4 mt-6">
                                ...
                                <p>Once a session is ended and confirmed, you'll need to
                                access the History page to make any additional entries or modifications.</p>
                            </div>
                        </div>
                    </section>
                </div>
