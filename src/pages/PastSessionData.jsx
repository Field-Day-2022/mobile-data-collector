            ...
            {displayDate}
              <AnimatePresence>
                {isOpen[index] &&
                  ...
                  >
                    <p className="text-lg"variants={item}>{`Project: ${pastData[openEntry].sessionData.project}`}</p>
                    <p className="text-lg"variants={item}>{`Site: ${pastData[openEntry].sessionData.site}`}</p>
                    <p className="text-lg"variants={item}>{`Array: ${pastData[openEntry].sessionData.array}`}</p>
                    ...
                    >Reopen this session?</motion.button>
                  </motion.div>
                }
              </AnimatePresence>
            </motion.li>
