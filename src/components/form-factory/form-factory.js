                ...
                switch (field.type) {
                    case CONSTANTS.SHORT_TEXT:
                        if (field.prompt === 'Toe-clip Code') {
                            return <ToeClipCodeWrapper field={field} key={field.prompt} />;
                        }
                        return <ShortTextWrapper field={field} key={field.prompt} />;
                    case CONSTANTS.LONG_TEXT:
                        return <LongTextWrapper key={field.prompt} field={field} />;
                    case CONSTANTS.COMBO_BOX:
                        return <ComboBoxWrapper key={field.prompt} field={field} />;
                    case CONSTANTS.CHECKBOX:
                        return <CheckboxWrapper key={field.prompt} field={field} />;
                    case CONSTANTS.NUMERIC:
                        return <NumberWrapper key={field.prompt} field={field} />;
                    case CONSTANTS.COUNTER:
                        return <CounterWrapper key={field.prompt} field={field} />;
                    default:
                        return '';
                }
            })}
