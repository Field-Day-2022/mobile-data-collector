...
import { Form, Button, Col, Container, FormGroup, FormLabel, Row } from 'react-bootstrap';
...
const FinishSession = (props) => {
    ...
    const trapAnswerArray = trapStatusObjects.filter((obj) => obj.set_name === 'trap statuses')[0]
        .answers;
                            ...
                            <Form noValidate validated={validated} onSubmit={handleSubmit}>
                                {fieldHasError('trapStatus') && (
                                    <p className="error-class">
                                        <span className="error-text">{errors.trapStatus}</span>
                                    </p>
                                )}
