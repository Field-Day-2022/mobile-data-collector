...
const UnsyncHistory = props => {
    ...
    const displaySessionLabels = (data) => {
        const getAnimalName = (formID) =>
            dataForms.find((form) => form.form_id === formID).form_name;
    ...
    useEffect(() => {
        ...
        let sessionsObj = {};
        setSessionInfo(
            sessionData.savedSessions.filter((sessionInfo) => {
                    ...
                    <Table striped bordered hover>
                        ...
                        <tbody>
                            ...
                            {sessionInfo.map((data) => {
                                return (
                                    <tr key={data[0].data.session_id}>
                                        <td>Session ID: {data[0].data.session_id}</td>
                                        <td>{displaySession(data)}</td>
                                    </tr>
                                );
                            })}
                        </tbody>
